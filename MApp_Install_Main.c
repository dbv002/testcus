...
#if(CUSTOMER_SEL == CUS_CELLO)
    		if(g_ShowInstallGuideMenuType == INSTALL_GUIDE_SHOW_HELP_PG)
    			MApp_ZUI_ACT_ExecuteWndAction(EN_EXE_INSTALL_SHOW_HELP_PAGE);
		    g_ShowInstallGuideMenuType = INSTALL_GUIDE_SHOW_MAIN_PG;
#endif
