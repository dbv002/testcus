...
#define MAPP_CADTV_MANUALTUNING_MAIN_C
...
EN_CADTV_MANUALTUNING_STATE enCadtvManualTuningState;

//////////////////////////////////////////////////////////
#if SZ_RF_AUTO_TEST
extern BOOLEAN TestStartFlag;
#endif
EN_RET MApp_CADTV_ManualTuning_Main(void)
{
    EN_RET enRetVal = EXIT_NULL;

    switch(enCadtvManualTuningState)
    {
        case STATE_CADTV_MANUALTUNING_INIT:
            ...
            enCadtvManualTuningState = STATE_CADTV_MANUALTUNING_WAIT;
        ...
        case STATE_CADTV_MANUALTUNING_WAIT:
...
//wing
       BOOLEAN bLockStatus = FALSE;
        ...
        case STATE_CADTV_MANUALTUNING_CLEAN_UP:
            MApp_ZUI_ACT_ShutdownOSD();
            MApp_ChannelChange_EnableChannel(MAIN_WINDOW);
            enCadtvManualTuningState = STATE_CADTV_MANUALTUNING_INIT;
            enRetVal = EXIT_CLOSE;
            break;

        case STATE_CADTV_MANUALTUNING_GOTO_STANDBY:
            MApp_ZUI_ACT_ShutdownOSD();
            u8KeyCode = KEY_POWER;
            enRetVal = EXIT_GOTO_STANDBY;
            break;

        case STATE_CADTV_MANUALTUNING_GOTO_MAIN_MENU:
            MApp_ZUI_ACT_ShutdownOSD();
            MApp_ChannelChange_EnableChannel(MAIN_WINDOW);
            enCadtvManualTuningState = STATE_CADTV_MANUALTUNING_INIT;
        ...
        case STATE_CADTV_MANUALTUNING_GOTO_CADTV_SCAN:
            enCadtvManualTuningState = STATE_CADTV_MANUALTUNING_WAIT;
...
#if SZ_RF_AUTO_TEST
void MApp_CADTV_ManualTuning_SetChannel(void)
{
...
#endif
#endif //  DVB_C_ENABLE
#undef MAPP_CADTV_MANUALTUNING_MAIN_C
